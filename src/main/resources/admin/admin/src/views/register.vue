  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">疫情网课管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xuesheng" class="input" type="text" placeholder="学生">
			   </div>
			 </div> -->
			<el-form-item label="学生" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuesheng" autocomplete="off" placeholder="学生" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshi" class="input" type="text" placeholder="教师">
			   </div>
			 </div> -->
			<el-form-item label="教师" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshi" autocomplete="off" placeholder="教师" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xuesheng) && `xuesheng` == this.tableName){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.jiaoshi) && `jiaoshi` == this.tableName){
