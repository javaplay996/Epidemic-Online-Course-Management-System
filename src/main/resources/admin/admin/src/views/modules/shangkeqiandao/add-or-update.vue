<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="打卡" prop="daka">
          <el-select v-model="ruleForm.daka" placeholder="请选择打卡">
            <el-option
                v-for="(item,index) in dakaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="打卡" prop="daka">
	      <el-input v-model="ruleForm.daka"
                placeholder="打卡" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="班级" prop="banji">
              <el-input v-model="ruleForm.banji" 
                placeholder="班级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="体温" prop="tiwen">
          <el-select v-model="ruleForm.tiwen" placeholder="请选择体温">
            <el-option
                v-for="(item,index) in tiwenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="课程" prop="kecheng">
          <el-select v-model="ruleForm.kecheng" placeholder="请选择课程">
            <el-option
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                          ...
                                          this.dakaOptions = "上课,下课".split(',')
                                                                                              this.tiwenOptions = "正常,发烧".split(',')
                                        this.$http({
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangkeqiandao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangkeqiandaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
