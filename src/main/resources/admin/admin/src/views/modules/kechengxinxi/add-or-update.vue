      ...
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.banji"
                placeholder="班级" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="作业" prop="zuoye">
          <file-upload
          tip="点击上传作业"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoye" label="作业" prop="zuoye">
            <el-button type="text" size="small" @click="download(ruleForm.zuoye)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                              </el-row>
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.gonghao = json.gonghao
                                  		...
                                  		if(json.jiaoshi!=''&&json.jiaoshi){
              		this.ruleForm.jiaoshi = json.jiaoshi
		}
                                                                                                } else {
