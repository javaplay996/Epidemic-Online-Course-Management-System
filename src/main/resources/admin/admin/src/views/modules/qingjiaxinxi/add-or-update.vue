          ...
          <el-form-item class="input" v-if="ruleForm.jieshushijian" label="结束时间" prop="jieshushijian">
              <el-input v-model="ruleForm.jieshushijian" 
                placeholder="结束时间" readonly></el-input>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="请假理由" prop="qingjialiyou">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qingjialiyou" label="请假理由" prop="qingjialiyou">
                    <span v-html="ruleForm.qingjialiyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qingjialiyou = this.ruleForm.qingjialiyou.replace(reg,'../../../springboot38dw8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
